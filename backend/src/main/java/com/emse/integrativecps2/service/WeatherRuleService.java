...
public class WeatherRuleService {
    ...
    public Optional<WeatherRule> getWeatherRuleById(Long id) {
        return weatherRuleRepository.findById(id);
    }

    public boolean deleteWeatherRule(Long id) {
        if (weatherRuleRepository.existsById(id)) {
            weatherRuleRepository.deleteById(id);
            return true;
        }
        return false;
    }
